...
| [Investment RAG Knowledge Base](rag-knowledge-base.md) <sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub> (Chinese-only) | Web ingestion entry, RAG API, Agent retrieval tools, chunking/dedup/provenance strategy, and rollback notes |
